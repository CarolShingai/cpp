...
void Harl::debug()
{
    std::cout << "[DEBUG]" << " I love having extra "
...
void Harl::info()
{
    ...
    "bacon costs more money. You didn’t put enough "
    "bacon in my burger! If you did, I wouldn’t be "
...
void Harl::error()
{
    std::cout << "[ERROR]" << " This is unacceptable! I want "
...
void Harl::complain(std::string level)
{
    ...
    std::cout << RED << "Error: Invalid level" << RESET << std::endl;
}